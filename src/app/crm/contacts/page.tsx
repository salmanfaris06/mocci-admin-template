...
export default async function ContactsPage() {
  ...
  const needFollowUp = contacts.filter(
    (contact) =>
      contact.conversationStatus === "needs_attention" ||
      contact.pipelineStageName === "Proposal",
  ).length;
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Contacts"
        description="Manage WhatsApp contacts, CRM status, and recent conversation context."
      />
